...
class AddressPage extends StatelessWidget {
                  ...
                  child: ListTile(
                    title: Text(
                      ...
                      style: const TextStyle(
                          fontWeight: FontWeight.bold, color: green4),
                    ),
                    subtitle: Text(
                      '${address.cidade}, ${address.bairro}',
                      style: const TextStyle(color: green6),
                    ),
  ...
  void _showAddressModal(BuildContext context, AddressController controller,
